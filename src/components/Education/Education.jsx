              ...
              <div className={classes.row_md_12}>
                <div className={classes.timeline_centered}>
                  ...
                  <article className={classes.timeline_entry}>
                    ...
                    <div className={classes.label}>
                      <h2>
                        Undergraduation at GGSIPU <span>2021-2025</span>
                      </h2>
                      <div className={classes.description}>
                        I completed my undergraduation in CSE (Computer Science and Engineering)
                        from <a href='http://ipu.ac.in/'>GGSIPU</a> with overall 86.71%.
                      </div >
                    </div>
                  </article>
                  {/* </ScrollAnimation> */}
                  ...
                  <article className={classes.timeline_entry}>
                    ...
                    <div className={classes.label}>
                      ...
                      <div className={classes.description}>
                        I have completed my higher education from SKV with major subjects as
                        Physics,Chemistry & Maths with 70% merit in CBSE board.{' '}
                      </div>
                    </div>
                  </article>
                  {/* </ScrollAnimation> */}
                  ...
                  <article>
                    ...
                    <div className={classes.label}>
                      <h2>Internship</h2>
                      <div className={classes.description}>Completed a 3-month internship as a Java Full Stack Project Intern with Infosys 
                        Springboard, gaining hands-on experience in end-to-end web application development using Java, Spring Boot, Angular, and MySQL.</div>
                    </div>
